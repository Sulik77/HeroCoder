...
const skills = [
  ...
  {
    title: "Jingu Mastery",
    opisanie: "Удары героя пробуждают мощь Цзиньгубана. Каждая четвертая атака по вражескому герою дарует четыре усиленные атаки с дополнительным уроном.",
    img: 'img/perks/6.png',
    branch: "CSS",
    params: {
      damage: 40,
  ...
  {
    title: "Spark Wraith",
    opisanie: "Призывает призрачную искру, которая медленно материализуется и сторожит выделенную область. При появлении врага искра бросается на него и взрывается, нанося жертве магический урон и замедляя её.",
    img: 'img/perks/7.png',
    branch: "CSS",
    params: {
      damage: 250,
  ...
  {
    title: "Shadowraze",
    opisanie: "Герой опустошает участок земли прямо перед собой, нанося урон всем врагам в зоне действия.  ",
    img: 'img/perks/9.png',
    branch: "HTML",
    params: {
      damage: 90,
  ...
  {
    title: "Chaos Bolt",
    opisanie: " Выпускает таинственный заряд энергии в указанного врага,  нанося случайный урон ",
  ...
  {
    title: "Blade Fury",
    opisanie: " Герой крутится в вихре сокрушительных ударов клинком, нанося урон врагам поблизости ",
